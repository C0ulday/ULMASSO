"""
Django settings for ULMASSO project.
...
#La date est mise en format français
USE_L10N = False
DATE_FORMATS = 'd/m/Y'
USE_L10N = False
USE_TZ = True
...
SECRET_KEY = 'django-insecure-9q4^+r#&62p3b(+sd41vln$j6%nb4+t=b(d%9&1ujd0q4qf-k9'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'Intranet.context_processors.notifications',
            ],
        },
    },
]

WSGI_APPLICATION = 'ULMASSO.wsgi.application'
